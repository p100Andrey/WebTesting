...
public class TARA01Test {
    ...
    @Test
    public void testTARA01() throws Exception {
        ...
        // ERROR: Caught exception [ERROR: Unsupported command [getTable | //div[@id='integration-test-amount-ranges']/div[2]/div/div/table.2.2 | ]]
    }
