...
public class TARE02Test {
    ...
    @Test
    public void testTARE02() throws Exception {
        ...
        // ERROR: Caught exception [ERROR: Unsupported command [getTable | //div[@id='integration-test-amount-ranges']/div[2]/div/div/table.9.2 | ]]
    }
